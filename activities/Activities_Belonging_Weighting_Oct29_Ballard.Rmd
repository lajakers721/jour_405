...
A: By having the summaries by race and putting everyone that is multiracial into one category, they are ignoring the specifics within these groups as well. I've seen it in forms before where you can choose multiple options that you apply to or that you can tell the difference between multiracial and what ethnicity they are. Once again with the gender not listed group, it does not include every gender which might be difficult to do, but it would be ideal to have every one listed. Also 38% women, 3% men is wild. 
...
A: The range would be 2.8088 since that is the maximum minus the minimum. 

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? 
A: Since the survey weight would be lower for 0.23, that means that this group is overrepresented in the data and thus you would need to weight it down to balance it out. 3.04 is the other side of that coin. This group would be underrepresented in the data and you would therefore need to weigh it up to balance it out. 

3. Why might some respondents be weighted more heavily than others? 
A: Some people are more likely to respond to surveys and therefore will need to be weighted more heavily since otherwise they would be overrepresented in the data. This would help balance it out.  
...
1. Which voter category shows the biggest difference between weighted and unweighted results? A: Rarely/never shows the biggest difference between weighted and unweighted results. 

2. How might these differences affect reporting on likely voter turnout? 
A: Would hopefully make reporting more accurate and create realistic understanding of who is showing up to vote by weighting it.
...
A: In this sample, I would lodge the guess that the people who always vote would be overrepresented and the people who vote rarely/never or sporadically would be underrepresented. These differences exist because of the weight and unweighting as weighting balances everything out. 
