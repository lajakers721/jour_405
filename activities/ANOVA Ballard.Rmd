...
A: The highest mean and median scores belong to the private colleges, but it is under 100 points above the public scores. This is great as the private is about 350 points above the community college group. Both public and private had people achieve the best score possible of a 1600, but community could not. The highest minimum was the private colleges as it was about 150 above the public minimum. 
...
A: There is a significant difference in SAT scores across college types as the f-value comes in as highly significant at a 99% confidence interval, shown by the 3 stars. This can be seen by the fact it comes in with the 3 decimals which is insane. 

2. Which specific college types differ from each other?
A: I mean they all show a significant enough difference between each other to say that all college types differ from one another. Private and public were kind of more similar but private is the most different from the rest. 

3. How large are these differences?
A: For each of these answers I am looking at the difference between the means of the different types of schools. Between public and private it is a difference of 74.405. Between public and community there is a difference of 292.551. Between private and community there is a difference of 366.956. 
...
A: 
Headline: Different types of schools have significantly different test scores

Lede:
Data reveals that private, public and community colleges test scores are different to the extent that it points to the college types differing from each other. 
