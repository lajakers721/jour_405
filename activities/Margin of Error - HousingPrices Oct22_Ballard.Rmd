...
52% support, sample size 100, margin of error = 10%
53% support, sample size 800, margin of error = 3.536%
55% support, sample size 400, margin of error = 5%
...
The headline is not statistically justified after finding the margins of error. This is because you have to subtract the margin of error from the support. This means the percentage of support taking margin of error into account is 42%, 49ish% and 50%. None of those are the majority of the population. Although you can do the margin of error above the support percentage, in some scenarios it is not accurate and therefore the statement is not justified. An alternative headline that would be more accurate for this scenario would be: "Support is Divided on New City Policy." 
...
Following the construction of a new transit line, the value of homes in the neighborhood have begun to rise, likely as a result of the construction. 

Before the construction of the new light rail line, the average price of homes was $285,000. Now that has risen by $19,500 up to $304,500, a percent change of 6.8%. 

The construction is a potential result of this. Being able to be near a light rail station has a ton of benefits for homeowners. They can travel across the area and the state much more easier and it does not take a lot of effort to go there. 
