...
A: Some people who fit into one category might be more likely to fill out the survey than one of a lower level. As a result of this, the higher levels will overrepresented and the lower levels would be underrepresented. 
...
A: College educated people are more likely to vote than not
...
A: Overall, the numbers stay relatively the same with very little change. The education group that showed the biggest change was the high school or less group as they were the only one to show pretty much any real change. College and some college saw changes of less than one. High school or less on the other hand saw a change of around two. It is not the largest change but it is the biggest change of the three. 

2. Why might the weighted results be considered more accurate than the unweighted results?

A: It can be a better representation of the population at large and thus it would be more accurate as a whole. 
...
A: Once again, it is the high school or less group. They have the highest overall chaneg at -2.738 in the yes category. 
...
A: If you do not know if a survey is weighted or unweighted, it could lead to judgment being passed that is inaccurate which is not good as a journalist. We seek truth and report it so if you do not understand survey weighting, you can compromise yourself. 

2. How might the differences between weighted and unweighted results affect how you would report on this data?
A: Unweighted could just be predominantly from one group compared to the other so the data would be skewed that way and I would thus note that. Put the information data somewhere in the article. Weighted data would be more accurate in terms of by populations, but it might not be fully accurate to what people actually say. Jumping to conclusions. 
...
A: Personally I would want to see the population info my sense so that it makes more sense. I would also like to see schools in the area to see if they are prevalent locally. 
