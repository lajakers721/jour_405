...
gdp_data |> 
  ...
  labs(title = "DJIA and GDP", x = "DJIA", y="GDP")
```
...
Between DJIA and GDP, there is a strong positive relationship between the two of them. I come to this conclusion because of the way the scatterplot appears. The correlation coefficient goes through the graph between all the points and not too far away. 
