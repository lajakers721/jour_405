...
Yes, test scores have improved. I can tell by comparing the numbers in the dataframe to the previous mean. The previous mean is 72.6, which is the average of all of the previous year's test scores, and everyone of the new scores is higher than this number, which means the test scores have imporved and so will the mean. 
...
The mean has increased, but the standard deviation has decreased. This means that the scores are very clustered together and because of this, I think their could be a chance of cheating which could point to the direction of a story. It could also just be that the new reading program is more effective or the test itself is easier. 
...
New title: "All new test scores are higher than last year's average."
...
**Hypotheses:**
Null: The new reading program has the same effectiveness as last year. 
Alternative: The new reading program is more effective than last year. 
...
Since the p value is less than the significance level and would thus lead us to reject the null hypothesis and accept the alternative hypothesis. I think it is that plain and simple to explain.
...
Third grade reading scores have improved

The superintendent accurately claimed that reading scores have improved as they have actually increased by a value of 3.15.
...
I mean the eye test is always one important thing to look at. Speed at which they read is another good test as you will usually read faster the better you are at it.
