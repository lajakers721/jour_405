...
A: Overall, the whole thing is a steady decrease but more specifically, it falls and then rises a little and then falls again. 
...
A: The confidence interval is represented by the pink shaded area. It shows that the mean and most points of the data fall within this 95% confidence interval. 

- What figure(s) accurately reflects the number of car thefts in a typical month? 
A: The mean of 460.4 would accurately relect this as is it is the average of all the car thefts by month. 
...
A: Car thefts are on the decrease but are still not low
...
A: There is a difference of about 60 between the first half and the second half. Since the null hypothesis states that there are no real differnece, I would say that the null hypothesis can be rejected. For it being crimes, 60 is not a small number and even if it is not crimes 60 is no small number.  
...
A: I think that my original headline is still pretty accurate in saying "Car thefts are on the decrease but are still not low." Car thefts are on the decrease as shown by the averages going down but it is still a noticeable number. I do not think it needs to be revised just maybe cleaned up a little bit. I think my editor would ask me to go in depth by months. Look at each month and see if those averages are all decreasing, see which are the most crime heavy months. She would probably ask me to look further back and see if this has been a continued trend or something new. 
